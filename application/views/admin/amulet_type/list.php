...
$(document).ready(function() {
    ...
    $('#btn_add_new').click(function() {
        redirect('<?php echo site_url('admin/amulet_type/add'); ?>');
    });
    ...
    <table class="list">
        <thead>
            <tr>
                ...
                ?></td>
                <td width="20%"><?php echo lang('image');?></td>
                <td width="20%"><?php echo lang('amulet_type_name');?></td>
                <td width="75%"><?php echo lang('amulet_type_description');?></td>
                <td width="75%"><?php echo lang('edit');?></td>
            </tr>
        </thead>
        <tbody>
